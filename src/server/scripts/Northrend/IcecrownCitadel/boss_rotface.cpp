...
//                if (instance)
		...
		instance->DoCompleteAchievement(RAID_MODE(CRITERIA_DANCES_WITH_OOZES_10N,CRITERIA_DANCES_WITH_OOZES_25N,CRITERIA_DANCES_WITH_OOZES_10H,CRITERIA_DANCES_WITH_OOZES_25H));
                if (Creature* professor = Unit::GetCreature(*me, instance->GetData64(DATA_PROFESSOR_PUTRICIDE)))
                    ...
                    switch (eventId)
                    {
                        case EVENT_SLIME_SPRAY:
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 1, 0.0f, true))
                            {
                                ...
                                DoSummon(CREATURE_OOZE_SPRAY_STALKER, pos, 8000, TEMPSUMMON_TIMED_DESPAWN);
...
//				if (Creature* rotface = Unit::GetCreature(*GetCaster(), instance->GetData64(DATA_ROTFACE)))
//                               	if (rotface->isAlive())	
//						instance->DoCompleteAchievement(rotfaceRAID_MODE(CRITERIA_DANCES_WITH_OOZES_10N,CRITERIA_DANCES_WITH_OOZES_25N,CRITERIA_DANCES_WITH_OOZES_10H,CRITERIA_DANCES_WITH_OOZES_25H));
                    }
                }
