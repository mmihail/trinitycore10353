...
//                    events.ScheduleEvent(EVENT_P2_TOUCH_OF_INSIGNIFICANCE, urand(6000, 9000), 0, PHASE_TWO);
                    events.ScheduleEvent(EVENT_P2_TOUCH_OF_INSIGNIFICANCE, 7200000, 0, PHASE_TWO);
...
//                            events.ScheduleEvent(EVENT_DOMINATE_MIND_H, urand(18000, 22000));
                            events.ScheduleEvent(EVENT_DOMINATE_MIND_H, urand(50000, 60000));
                            break;
                        case EVENT_P1_SUMMON_WAVE:
                            SummonWaveP1();
//                            events.ScheduleEvent(EVENT_P1_SUMMON_WAVE, 60000, 0, PHASE_ONE);
                            events.ScheduleEvent(EVENT_P1_SUMMON_WAVE, 120000, 0, PHASE_ONE);
                            break;
...
//                            events.ScheduleEvent(EVENT_P2_SUMMON_WAVE, 60000, 0, PHASE_TWO);
                            events.ScheduleEvent(EVENT_P2_SUMMON_WAVE, 120000, 0, PHASE_TWO);
                            break;
                        case EVENT_BERSERK:
...
//                    me->UpdateEntry(CREATURE_DEFORMED_FANATIC);
                if (spell->Id == SPELL_DARK_TRANSFORMATION_T)
                {
