...
enum eScriptTexts
{
    ...
    // Professor Putricide
    SAY_AGGRO                       = -1666026,
    EMOTE_UNSTABLE_EXPERIMENT       = -1666027,
    SAY_PHASE_TRANSITION_HEROIC     = -1666028,
    SAY_TRANSFORM_1                 = -1666029,
    SAY_TRANSFORM_2                 = -1666030,    // always used for phase2 change, DO NOT GROUP WITH SAY_TRANSFORM_1
    EMOTE_MALLEABLE_GOO             = 9,
    EMOTE_CHOKING_GAS_BOMB          = -1666032,
    SAY_KILL                        = -1666031,
    SAY_BERSERK                     = -1666033,
    SAY_DEATH                       = -1666034,
};
...
//                        Talk(SAY_ROTFACE_OOZE_FLOOD);
			DoScriptText(SAY_ROTFACE_OOZE_FLOOD, me);
