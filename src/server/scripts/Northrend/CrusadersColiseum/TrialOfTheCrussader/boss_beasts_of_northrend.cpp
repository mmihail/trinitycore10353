...
#define Acid_Timer              7200000
#define Paralytic_Timer         isMobile ? 15000 : 1500
//#define Burn_Timer              urand(6000, 8000)
#define Burn_Timer              7200000
#define Molten_Timer            isMobile ? 15000 : 1500
...
#define MassiveCrash_Timer          7200000
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            else
            {
                ...
                if (massiveCrashStep_Timer < diff)
                {
                    ...
                    case 0:
                    case 1:
                        me->GetMotionMaster()->MoveJump(positionCenter.GetPositionX(), positionCenter.GetPositionY(),
                            positionCenter.GetPositionZ(), 50.0f, 100.0f);
                        ...
                        /*if (massiveCrashTarget_Guid)
                        {
                            if (Unit* target = ObjectAccessor::GetUnit((*me), massiveCrashTarget_Guid))
                            {
                                if (target->isAlive())
                                {
                                    ...
                                    me->GetMotionMaster()->MoveJump(2*me->GetPositionX()-targetsX, 2*me->GetPositionY()-targetsY,
                                        me->GetPositionZ(), 10.0f, 20.0f);
                                    me->MonsterYell("Jumping back", 0, 0);
                                }
                            }
                        }*/
